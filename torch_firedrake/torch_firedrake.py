...
# def to_fd(numpy_array, fenics_var_template):
#     """Convert numpy array to FEniCS variable"""
#     if isinstance(fenics_var_template, (fd.Constant, fda.Constant)):
#         if numpy_array.shape == (1,):
#             return type(fenics_var_template)(numpy_array[0])
#         else:
#             return type(fenics_var_template)(numpy_array)

#     if isinstance(fenics_var_template, (fd.Function, fda.Function)):
...
#     if isinstance(fenics_var_template, fda.AdjFloat):
#         return fda.AdjFloat(numpy_array)
